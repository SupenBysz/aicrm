...
仓库同时维护两层范围：Phase 1 是已经锁定的多租户身份、组织、权限和 AI 配置基线；Post-Phase1 v9.1 正在建设 Matrix Account、可信 Desktop、Agent Executor、Codex 授权和 AI 登录脚本维护闭环。v9.1 当前仍处于合同覆盖与安全止血阶段，新增账号自动化、可信快照完成和 AI 自动修复的生产门禁均未开启。
